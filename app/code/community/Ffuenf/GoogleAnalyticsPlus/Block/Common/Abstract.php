 ...
 */
class Ffuenf_GoogleAnalyticsPlus_Block_Common_Abstract extends Mage_Core_Block_Template
{
    ...
    /**
     * are we converting currencies.
     *
     * @return bool
     */
    public function isConvertCurrencyEnabled()
    {
        return Mage::getStoreConfigFlag('google/analyticsplus/convertcurrencyenabled');
    }
}
