 ...
 */
class Ffuenf_GoogleAnalyticsPlus_Block_Remarketing extends Ffuenf_GoogleAnalyticsPlus_Block_GaConversion
{
    ...
    {
        parent::_construct();
        $this->setTemplate('ffuenf/googleanalyticsplus/remarketing.phtml');
    }
